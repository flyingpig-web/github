...
$(function () {
  ...
  const cuts = [
    ...
    // 2-2 [다음] (자막)
    {
      ...
      text: "이후 한국광복군은 인도·미얀마 전선 등에서 연합군과 협력하며 항일 작전을 수행했다.",
      vo: "intro_2-2.wav",
      next: true,
    },
    // 3-1 장교 막사 건물 터치
    ...
    // 3-2 작전 현황판 터치 (자막)
    {
      ...
      text: "1944년, 한국광복군은 미국 전략 정보국 ‘OSS’와 함께 조국으로 향하기 위한 국내 진공작전을 추진했다.",
      vo: "intro_3-2.wav",
      hot: { x: 0.42, y: 0.62 },
    },
    // 3-3 [다음] (자막)
    {
      ...
      text: "1945년 봄, 한국광복군 제2지대는 무전, 정보수집, 폭파, 침투 등 OSS 특수훈련을 받았다.",
      vo: "intro_3-3.wav",
      next: true,
    },
    // 4-1 해 터치
    ...
    // 4-2 [다음] → 목표① (자막)
    {
      ...
      text: "하지만 작전 준비가 진행될수록 훈련소 경비와 보안 유지도 한국광복군의 주요 임무가 됐다.",
      vo: "intro_4-2.wav",
      next: true,
    },
  ];
